...
<p class="par">
    Система IronBrain позволяет автоматизировать создание билетов, организовать их нарезку и поиск по ним, а также множество других полезных функций. В этой статье вы узнаете, откуда зародились идеи, лежащие в основе IronBrain, как правильно работать с системой, а также конкретные практические случаи - в чём IB может помочь вам и насколько сильно.
</p><br>

<p class="par">
P.S.: Раздел "Эволюция IronBrain" написан скорее для программистов и там много технических терминов, которые вы можете пропустить, если не разбираетесь в области IT.
</p>
...
<ib:spoiler title="Конкретные случаи применения">
    ...
    <ib:spoiler title="Более эффективный разбор тестов">
        ...
        <p class="par">
            Алгоритм существенно отличается - тест это не книга и не видеокурс. Он не имеет структуры. Там всё случайным образом перемешано и нет смысла пытаться свести это к иерархии. Просто создавайте не привязанный ни к чему билет, нажав в меню "+Билет". Но не забудьте привязать его хотя бы к одной области.
        </p>
    </ib:spoiler>
...
<ib:spoiler title="Техническая реализация">
    <p class="par">
        Я начал увлекаться программированием ещё в далёком 2014 году.
    </p>
</ib:spoiler>

<ib:spoiler title="Конспектируем книги, учебные курсы и статьи">
    <p class="par">
        В этом разделе я расскажу вам, откуда пошли корни IronBrain и вообще как
    </p>
</ib:spoiler>

<ib:spoiler title="Извлекаем опыт">
    <p class="par">
        В этом разделе я расскажу вам, откуда пошли корни IronBrain и вообще как
    </p>
</ib:spoiler>
